...
const tools: Tool[] = [
  ...
  },
  {
    ...
    path: "/TextChecker",
    description:
      "Проверка орфографии, пунктуации и оформления с подсветкой прямо в тексте",
    icon: "🖋️",
    features: [
      "Словарь русского языка в браузере (без ИИ и сервера)",
      "Запятые, вводные слова, «-тся/-ться», «согласно договору»",
      "Двойные пробелы, тире, кавычки-ёлочки, сбитая раскладка",
      "Исправление одним кликом и режим «исправить всё»",
    ],
    note: "Смысл и согласование слов правилами не проверяются",
  },
  //   {
