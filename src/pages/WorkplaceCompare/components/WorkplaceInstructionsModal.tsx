...
export const WorkplaceInstructionsModal: React.FC<{
  ...
  <InstructionsModal
    isOpen={isOpen}
    onClose={onClose}
    title="📋 Инструкция по сравнению рабочих мест"
  ...
  >
    <div className="instructions-section">
      ...
      <p>
        Инструмент предназначен для сравнения двух версий файлов с данными о
        рабочих местах и выявления изменений между ними. Особое внимание
    ...
    <div className="instructions-section">
      ...
      <ul>
        ...
        <li>
          Данные должны находиться на <strong>третьем листе</strong> (Sheet3)
        </li>
        <li>Структура файлов должна быть идентичной</li>
        <li>
          Обязательные колонки: Адрес, Этаж, РМ, Тип РМ, Признак, Таб. №, ФИО и
          другие
        </li>
      </ul>
    </div>
      ...
      <ol>
        ...
        <li>
          ...
          <ul>
            ...
            <li>
              <span className="workplace-status-badge new">СТАЛО</span> - новое
              значение
            </li>
            <li>
              <span className="workplace-status-badge added">НОВАЯ</span> - новая
              запись
            </li>
            <li>
              <span className="workplace-status-badge deleted">УДАЛЕНА</span> -
              удаленная запись
            </li>
          </ul>
        </li>
    ...
    <div className="instructions-section">
      ...
      <ul>
        ...
        <li>
          <strong>Удаленные рабочие места</strong> - записи, удаленные из файла
        </li>
        <li>
    ...
    <div className="instructions-section">
      ...
      <ul>
        ...
        <li>
          При фильтрации по изменениям важные поля выделяются жирным шрифтом
        </li>
    ...
    <div className="instructions-section">
      ...
      <ul>
        ...
        <li>
          <strong>Измененные поля</strong> - фильтрация по конкретным измененным
          колонкам
        </li>
        <li>
        ...
        <li>
          <strong>Занятость РМ</strong> - фильтр по количеству рабочих мест
        </li>
        <li>
          <strong>Специальные фильтры</strong> - изменения признака на "Резерв"
          или "Партнер"
        </li>
      </ul>
    </div>
    ...
    <div className="instructions-section">
      ...
      <ul>
        <li>
          Используйте фильтр "Измененные поля" для быстрого поиска изменений в
          конкретных атрибутах
        </li>
        <li>
          Фильтр "→ Резерв" помогает найти рабочие места, переведенные в резерв
        </li>
        <li>
          Фильтр "→ Партнер" выделяет рабочие места, переданные партнерам
        </li>
        <li>Отмечайте важные строки чекбоксами для последующего экспорта</li>
        <li>
          Используйте полноэкранный режим для работы с большими объемами данных
        </li>
      </ul>
    </div>
    ...
    <div className="instructions-section">
      ...
      <p>
        Функция экспорта сохраняет все отфильтрованные данные в Excel-файл с
        сохранением цветового кодирования и форматирования. В экспортированном
        файле:
      </p>
      <ul>
    ...
    <div className="instructions-section">
      ...
      <ul>
        <li>
          ...
          Убедитесь, что файлы имеют правильный формат и данные находятся на
          третьем листе
        </li>
        <li>
          <strong>Не отображаются изменения:</strong>
          Проверьте, что структура файлов идентична и используются правильные
          колонки
        </li>
        <li>
