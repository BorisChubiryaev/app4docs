...
export const SvgInstructionsModal: React.FC<{
  ...
  <InstructionsModal
    isOpen={isOpen}
    onClose={onClose}
    title="📋 Инструкция по использованию SVG конвертера"
  ...
  >
    ...
    <div className="instructions-section">
      ...
      <ul>
        ...
        <li>
          <strong>📝 Вставка кода:</strong> Вставьте SVG код напрямую в текстовое
          поле
        </li>
      </ul>
  ...
  <text x="100" y="110" text-anchor="middle" fill="white">SVG</text>
    ...
    <div className="instructions-section">
      ...
      <ul>
        <li>
          <strong>PNG</strong> - формат с поддержкой прозрачности, идеален для
          логотипов и графики
        </li>
        <li>
          <strong>JPEG</strong> - формат с настраиваемым качеством, подходит для
          фотографий
        </li>
      </ul>
      ...
      <ul>
        ...
        <li>
          <strong>Сохранять пропорции:</strong> Автоматическое масштабирование
          без искажений
        </li>
      </ul>
    </div>
    ...
    <div className="instructions-section">
      ...
      <ul>
        ...
        <li>
          <strong>Для печати:</strong> 300 DPI (умножьте нужный размер в дюймах
          на 300)
        </li>
        <li>
    ...
    <div className="instructions-section">
      ...
      <p>
        Инструмент сохраняет последние 5 конвертаций, позволяя быстро скачать
        ранее преобразованные изображения без повторной конвертации.
      </p>
    </div>
    ...
    <div className="instructions-section">
      ...
      <ul>
        <li>
          ...
          Убедитесь, что файл имеет расширение .svg и содержит валидный SVG код
        </li>
        <li>
        ...
        <li>
          ...
          Для PNG - уменьшите размер изображения, для JPEG - снизьте качество
        </li>
        <li>
